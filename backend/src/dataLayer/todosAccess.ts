  ...
  async updateTodo(
    ...
    await this.docClient
      .update({
        ...
        UpdateExpression:
          'set #name = :name, #dueDate = :duedate, #done = :done, #hasAttachment = :hasAttachment, #attachmentName = :attachmentName',
        ExpressionAttributeValues: {
          ':name': updatedTodo.name,
          ':duedate': updatedTodo.dueDate,
          ':done': updatedTodo.done,
          ':hasAttachment': updatedTodo.hasAttachment,
          ':attachmentName': updatedTodo.attachmentName
        },
